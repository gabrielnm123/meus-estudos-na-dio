...
SECRET_KEY = 'django-insecure-*=p((ke9@ozkv5^s6oxsf93=tuoi^hh7r74kgu!)5%oscch7hx'
...
TEMPLATES = [
    {
        ...
        'DIRS': [Path.joinpath(BASE_DIR, 'templates')], # no video é os.path.join(...), registramos o templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [

...
1. Utilize a API `https://api.thecatapi.com/v1/images/search?size=med&mime_types=jpg&format=json&has_breeds=true&order=RANDOM&page=0&limit=1` para fazer as chamadas com o método `fetch()`;
